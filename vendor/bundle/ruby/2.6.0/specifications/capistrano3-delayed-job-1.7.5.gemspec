# -*- encoding: utf-8 -*-
# stub: capistrano3-delayed-job 1.7.5 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<capistrano>.freeze, ["~> 3.0", ">= 3.0.0"])
      s.add_runtime_dependency(%q<daemons>.freeze, ["~> 1.2.4"])
      s.add_development_dependency(%q<rake>.freeze, [">= 10.0"])
      s.add_development_dependency(%q<rubocop>.freeze, ["~> 0.0", ">= 0.39.0"])
    else
      s.add_dependency(%q<capistrano>.freeze, ["~> 3.0", ">= 3.0.0"])
      s.add_dependency(%q<daemons>.freeze, ["~> 1.2.4"])
      s.add_dependency(%q<rake>.freeze, [">= 10.0"])
      s.add_dependency(%q<rubocop>.freeze, ["~> 0.0", ">= 0.39.0"])
    end
  else
    s.add_dependency(%q<capistrano>.freeze, ["~> 3.0", ">= 3.0.0"])
    s.add_dependency(%q<daemons>.freeze, ["~> 1.2.4"])
